...
### [16] [One Model, Many Skills: Parameter-Efficient Fine-Tuning for Multitask Code Analysis](https://arxiv.org/abs/2603.09978)
...
### [17] [Safety Under Scaffolding: How Evaluation Conditions Shape Measured Safety](https://arxiv.org/abs/2603.10044)
*David Gringras*
...
### [18] [Toward Epistemic Stability: Engineering Consistent Procedures for Industrial LLM Hallucination Reduction](https://arxiv.org/abs/2603.10047)
...
### [19] [DUCTILE: Agentic LLM Orchestration of Engineering Analysis in Product Development Practice](https://arxiv.org/abs/2603.10249)
...
### [20] [MALTA: Maintenance-Aware Technical Lag, Estimation to Address Software Abandonment](https://arxiv.org/abs/2603.10265)
...
### [21] [SpecOps: A Fully Automated AI Agent Testing Framework in Real-World GUI Environments](https://arxiv.org/abs/2603.10268)
...
### [22] [From Verification to Herding: Exploiting Software's Sparsity of Influence](https://arxiv.org/abs/2603.10478)
...
### [23] [FP-Predictor - False Positive Prediction for Static Analysis Reports](https://arxiv.org/abs/2603.10558)
...
### [24] [QuantumX: an experience for the consolidation of Quantum Computing and Quantum Software Engineering as an emerging discipline](https://arxiv.org/abs/2603.10621)
...
### [25] [ESG Reporting Lifecycle Management with Large Language Models and AI Agents](https://arxiv.org/abs/2603.10646)
...
### [26] [From Education to Evidence: A Collaborative Practice Research Platform for AI-Integrated Agile Development](https://arxiv.org/abs/2603.10679)
...
### [27] [Packaging Jupyter notebooks as installable desktop apps using LabConstrictor](https://arxiv.org/abs/2603.10704)
...
### [28] [Exploring Indicators of Developers' Sentiment Perceptions in Student Software Projects](https://arxiv.org/abs/2603.10864)
...
### [29] [STADA: Specification-based Testing for Autonomous Driving Agents](https://arxiv.org/abs/2603.10940)
...
### [30] [Artificial Intelligence as a Catalyst for Innovation in Software Engineering](https://arxiv.org/abs/2603.10994)
...
### [31] [AgentServe: Algorithm-System Co-Design for Efficient Agentic AI Serving on a Consumer-Grade GPU](https://arxiv.org/abs/2603.10342)
...
### [32] [S-HPLB: Efficient LLM Attention Serving via Sparsity-Aware Head Parallelism Load Balance](https://arxiv.org/abs/2603.10353)
...
### [33] [CD-Raft: Reducing the Latency of Distributed Consensus in Cross-Domain Sites](https://arxiv.org/abs/2603.10555)
...
### [34] [Double-Precision Matrix Multiplication Emulation via Ozaki-II Scheme with FP8 Quantization](https://arxiv.org/abs/2603.10634)
...
### [35] [Topological Analysis for Identifying Anomalies in Serverless Platforms](https://arxiv.org/abs/2603.10850)
...
### [36] [Data Augmentation and Convolutional Network Architecture Influence on Distributed Learning](https://arxiv.org/abs/2603.10902)
...
### [37] [Evaluating Generalization Mechanisms in Autonomous Cyber Attack Agents](https://arxiv.org/abs/2603.10041)
...
### [38] [Targeted Bit-Flip Attacks on LLM-Based Agents](https://arxiv.org/abs/2603.10042)
...
### [39] [OAuthHub: Mitigating OAuth Data Overaccess through a Local Data Hub](https://arxiv.org/abs/2603.10056)
...
### [40] [SBOMs into Agentic AIBOMs: Schema Extensions, Agentic Orchestration, and Reproducibility Evaluation](https://arxiv.org/abs/2603.10057)
...
### [41] [Tool Receipts, Not Zero-Knowledge Proofs: Practical Hallucination Detection for AI Agents](https://arxiv.org/abs/2603.10060)
*Abhinaba Basu*
...
### [42] [Building Privacy-and-Security-Focused Federated Learning Infrastructure for Global Multi-Centre Healthcare Research](https://arxiv.org/abs/2603.10063)
...
### [43] [ADVERSA: Measuring Multi-Turn Guardrail Degradation and Judge Reliability in Large Language Models](https://arxiv.org/abs/2603.10068)
...
### [44] [ACE Runtime - A ZKP-Native Blockchain Runtime with Sub-Second Cryptographic Finality](https://arxiv.org/abs/2603.10242)
*Jian Sheng Wang*
...
### [45] [Why LLMs Fail: A Failure Analysis and Partial Success Measurement for Automated Security Patch Generation](https://arxiv.org/abs/2603.10072)
*Amir Al-Maamari*
...
### [46] [CacheSolidarity: Preventing Prefix Caching Side Channels in Multi-tenant LLM Serving Systems](https://arxiv.org/abs/2603.10726)
...
### [47] [TASER: Task-Aware Spectral Energy Refine for Backdoor Suppression in UAV Swarms Decentralized Federated Learning](https://arxiv.org/abs/2603.10075)
...
### [48] [Amnesia: Adversarial Semantic Layer Specific Activation Steering in Large Language Models](https://arxiv.org/abs/2603.10080)
...
### [49] [Multi-Stream Perturbation Attack: Breaking Safety Alignment of Thinking LLMs Through Concurrent Task Interference](https://arxiv.org/abs/2603.10091)
*Fan Yang*
...
### [50] [Detecting Privilege Escalation with Temporal Braid Groups](https://arxiv.org/abs/2603.10094)
*Christophe Parisel*
...
### [51] [Compatibility at a Cost: Systematic Discovery and Exploitation of MCP Clause-Compliance Vulnerabilities](https://arxiv.org/abs/2603.10163)
...
### [52] [MCP-in-SoS: Risk assessment framework for open-source MCP servers](https://arxiv.org/abs/2603.10194)
...
### [53] [Paladin: A Policy Framework for Securing Cloud APIs by Combining Application Context with Generative AI](https://arxiv.org/abs/2603.10228)
...
### [54] [Post-Quantum Entropy as a Service for Embedded Systems](https://arxiv.org/abs/2603.10274)
...
### [55] [PRoADS: Provably Secure and Robust Audio Diffusion Steganography with latent optimization and backward Euler Inversion](https://arxiv.org/abs/2603.10314)
...
### [56] [The Orthogonal Vulnerabilities of Generative AI Watermarks: A Comparative Empirical Benchmark of Spatial and Latent Provenance](https://arxiv.org/abs/2603.10323)
...
### [57] [Don't Let the Claw Grip Your Hand: A Security Analysis and Defense Framework for OpenClaw](https://arxiv.org/abs/2603.10387)
...
### [58] [Naïve Exposure of Generative AI Capabilities Undermines Deepfake Detection](https://arxiv.org/abs/2603.10504)
...
### [59] [An Approach for Safe and Secure Software Protection Supported by Symbolic Execution](https://arxiv.org/abs/2603.10608)
...
### [60] [Detecting and Eliminating Neural Network Backdoors Through Active Paths with Application to Intrusion Detection](https://arxiv.org/abs/2603.10641)
...
### [61] [Repurposing Backdoors for Good: Ephemeral Intrinsic Proofs for Verifiable Aggregation in Cross-silo Federated Learning](https://arxiv.org/abs/2603.10692)
...
### [62] [AttriGuard: Defeating Indirect Prompt Injection in LLM Agents via Causal Attribution of Tool Invocations](https://arxiv.org/abs/2603.10749)
...
### [63] [A PUF-Based Approach for Copy Protection of Intellectual Property in Neural Network Models](https://arxiv.org/abs/2603.10753)
...
### [64] [Incremental Federated Learning for Intrusion Detection in IoT Networks under Evolving Threat Landscape](https://arxiv.org/abs/2603.10776)
...
### [65] [Re-Evaluating EVMBench: Are AI Agents Ready for Smart Contract Security?](https://arxiv.org/abs/2603.10795)
...
### [66] [MAD: Memory Allocation meets Software Diversity](https://arxiv.org/abs/2603.10840)
...
### [67] [Layered Performance Analysis of TLS 1.3 Handshakes: Classical, Hybrid, and Pure Post-Quantum Key Exchange](https://arxiv.org/abs/2603.11006)
...
### [68] [Separating Oblivious and Adaptive Differential Privacy under Continual Observation](https://arxiv.org/abs/2603.11029)
