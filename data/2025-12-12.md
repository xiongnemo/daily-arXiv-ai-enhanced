...
### [51] [Search-based Software Testing Driven by Domain Knowledge: Reflections and New Perspectives](https://arxiv.org/abs/2512.10079)
...
### [52] [ATLAS: Automated Toolkit for Large-Scale Verified Code Synthesis](https://arxiv.org/abs/2512.10173)
...
### [53] [Does SWE-Bench-Verified Test Agent Ability or Model Memory?](https://arxiv.org/abs/2512.10218)
...
### [54] [Studying and Automating Issue Resolution for Software Quality](https://arxiv.org/abs/2512.10238)
*Antu Saha*
...
### [55] [Cross-modal Retrieval Models for Stripped Binary Analysis](https://arxiv.org/abs/2512.10393)
...
### [56] [UniCoR: Modality Collaboration for Robust Cross-Language Hybrid Code Retrieval](https://arxiv.org/abs/2512.10452)
...
### [57] [Decoding Human-LLM Collaboration in Coding: An Empirical Study of Multi-Turn Conversations in the Wild](https://arxiv.org/abs/2512.10493)
...
### [58] [Analyzing developer discussions on EU and US privacy legislation compliance in GitHub repositories](https://arxiv.org/abs/2512.10618)
...
### [59] [PACIFIC: a framework for generating benchmarks to check Precise Automatically Checked Instruction Following In Code](https://arxiv.org/abs/2512.10713)
...
### [60] [Zorya: Automated Concolic Execution of Single-Threaded Go Binaries](https://arxiv.org/abs/2512.10799)
...
### [61] [IoTEdu: Access Control, Detection, and Automatic Incident Response in Academic IoT Networks](https://arxiv.org/abs/2512.09934)
...
### [62] [Blockchain-Anchored Audit Trail Model for Transparent Inter-Operator Settlement](https://arxiv.org/abs/2512.09938)
...
### [63] [ZK-APEX: Zero-Knowledge Approximate Personalized Unlearning with Executable Proofs](https://arxiv.org/abs/2512.09953)
...
### [64] [Cross-Layer Isochronous Diffusion Protocol (CIDP): A Rigorous Information-Theoretic and Control-Theoretic Framework for Sovereign Tactical Anonymity](https://arxiv.org/abs/2512.09954)
*Pravin G*
...
### [65] [When Quantum Federated Learning Meets Blockchain in 6G Networks](https://arxiv.org/abs/2512.09958)
...
### [66] [TRUCE: TRUsted Compliance Enforcement Service for Secure Health Data Exchange](https://arxiv.org/abs/2512.09959)
...
### [67] [A Comparative Analysis of zk-SNARKs and zk-STARKs: Theory and Practice](https://arxiv.org/abs/2512.10020)
...
### [68] [Malicious GenAI Chrome Extensions: Unpacking Data Exfiltration and Malicious Behaviours](https://arxiv.org/abs/2512.10029)
...
### [69] [LLM-PEA: Leveraging Large Language Models Against Phishing Email Attacks](https://arxiv.org/abs/2512.10104)
...
### [70] [From Lab to Reality: A Practical Evaluation of Deep Learning Models and LLMs for Vulnerability Detection](https://arxiv.org/abs/2512.10485)
...
### [71] [Lightweight Security for Private Networks: Real-World Evaluation of WireGuard](https://arxiv.org/abs/2512.10135)
...
### [72] [Watermarks for Language Models via Probabilistic Automata](https://arxiv.org/abs/2512.10185)
...
### [73] [Graph Neural Network Based Adaptive Threat Detection for Cloud Identity and Access Management Logs](https://arxiv.org/abs/2512.10280)
...
### [74] [Bit of a Close Talker: A Practical Guide to Serverless Cloud Co-Location Attacks](https://arxiv.org/abs/2512.10361)
...
### [75] [FLARE: A Wireless Side-Channel Fingerprinting Attack on Federated Learning](https://arxiv.org/abs/2512.10296)
...
### [76] [Differential Privacy for Secure Machine Learning in Healthcare IoT-Cloud Systems](https://arxiv.org/abs/2512.10426)
...
### [77] [A Proof of Success and Reward Distribution Protocol for Multi-bridge Architecture in Cross-chain Communication](https://arxiv.org/abs/2512.10667)
...
### [78] [TriHaRd: Higher Resilience for TEE Trusted Time](https://arxiv.org/abs/2512.10732)
...
### [79] [Stealth and Evasion in Rogue AP Attacks: An Analysis of Modern Detection and Bypass Techniques](https://arxiv.org/abs/2512.10470)
...
### [80] [LLM-Assisted AHP for Explainable Cyber Range Evaluation](https://arxiv.org/abs/2512.10487)
...
### [81] [Authority Backdoor: A Certifiable Backdoor Mechanism for Authoring DNNs](https://arxiv.org/abs/2512.10600)
...
### [82] [Objectives and Design Principles in Offline Payments with Central Bank Digital Currency (CBDC)](https://arxiv.org/abs/2512.10636)
...
### [83] [Adaptive Intrusion Detection System Leveraging Dynamic Neural Models with Adversarial Learning for 5G/6G Networks](https://arxiv.org/abs/2512.10637)
...
### [84] [Virtual camera detection: Catching video injection attacks in remote biometric systems](https://arxiv.org/abs/2512.10653)
...
### [85] [Metaphor-based Jailbreaking Attacks on Text-to-Image Models](https://arxiv.org/abs/2512.10766)
...
### [86] [A study of the spectrum resource leasing method based on ERC4907 extension](https://arxiv.org/abs/2512.09942)
...
### [87] [ELANA: A Simple Energy and Latency Analyzer for LLMs](https://arxiv.org/abs/2512.09946)
...
### [88] [TDC-Cache: A Trustworthy Decentralized Cooperative Caching Framework for Web3.0](https://arxiv.org/abs/2512.09961)
...
### [89] [GoodSpeed: Optimizing Fair Goodput with Adaptive Speculative Decoding in Distributed Edge Inference](https://arxiv.org/abs/2512.09963)
...
### [90] [Design Space Exploration of DMA based Finer-Grain Compute Communication Overlap](https://arxiv.org/abs/2512.10236)
...
### [91] [Hybrid Learning and Optimization-Based Dynamic Scheduling for DL Workloads on Heterogeneous GPU Clusters](https://arxiv.org/abs/2512.10271)
...
### [92] [High-Dimensional Data Processing: Benchmarking Machine Learning and Deep Learning Architectures in Local and Distributed Environments](https://arxiv.org/abs/2512.10312)
...
### [93] [Making Wide Stripes Practical: Cascaded Parity LRCs for Efficient Repair and High Reliability](https://arxiv.org/abs/2512.10425)
...
### [94] [Clustered Federated Learning with Hierarchical Knowledge Distillation](https://arxiv.org/abs/2512.10443)
...
### [95] [ESS: An Offload-Centric Latent-Cache Management Architecture for DeepSeek-V3.2-Exp](https://arxiv.org/abs/2512.10576)
