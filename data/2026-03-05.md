...
### [11] [Maude-HCS: Model Checking the Undetectability-Performance Tradeoffs of Hidden Communication Systems](https://arxiv.org/abs/2603.03369)
...
### [12] [Sleeper Cell: Injecting Latent Malice Temporal Backdoors into Tool-Using LLMs](https://arxiv.org/abs/2603.03371)
...
### [13] [Zero-Knowledge Federated Learning with Lattice-Based Hybrid Encryption for Quantum-Resilient Medical AI](https://arxiv.org/abs/2603.03398)
*Edouard Lansiaux*
...
### [14] [Sharing is caring: Attestable and Trusted Workflows out of Distrustful Components](https://arxiv.org/abs/2603.03403)
...
### [15] [On Google's SynthID-Text LLM Watermarking System: Theoretical Analysis and Empirical Validation](https://arxiv.org/abs/2603.03410)
...
### [16] [PRIVATEEDIT: A Privacy-Preserving Pipeline for Face-Centric Generative Image Editing](https://arxiv.org/abs/2603.03412)
...
### [17] [Parallel Test-Time Scaling with Multi-Sequence Verifiers](https://arxiv.org/abs/2603.03417)
...
### [18] [Analyzing the Impact of Adversarial Attacks on C-V2X-Enabled Road Safety: An Age of Information Perspective](https://arxiv.org/abs/2603.03462)
...
### [19] [DKD-KAN: A Lightweight knowledge-distilled KAN intrusion detection framework, based on MLP and KAN](https://arxiv.org/abs/2603.03486)
*Mohammad Alikhani*
...
### [20] [Scrambler: Mixed Boolean Arithmetic Obfuscation Tool Using E-graph and Equality Expansion](https://arxiv.org/abs/2603.03624)
...
### [21] [Goal-Driven Risk Assessment for LLM-Powered Systems: A Healthcare Case Study](https://arxiv.org/abs/2603.03633)
...
### [22] [Reckless Designs and Broken Promises: Privacy Implications of Targeted Interactive Advertisements on Social Media Platforms](https://arxiv.org/abs/2603.03659)
...
### [23] [Internet malware propagation: Dynamics and control through SEIRV epidemic model with relapse and intervention](https://arxiv.org/abs/2603.03712)
...
### [24] [Zero-Knowledge Proof (ZKP) Authentication for Offline CBDC Payment System Using IoT Devices](https://arxiv.org/abs/2603.03804)
...
### [25] [On the Suitability of LLM-Driven Agents for Dark Pattern Audits](https://arxiv.org/abs/2603.03881)
...
### [26] [Measuring Privacy vs. Fidelity in Synthetic Social Media Datasets](https://arxiv.org/abs/2603.03906)
...
### [27] [When Safety Becomes a Vulnerability: Exploiting LLM Alignment Homogeneity for Transferable Blocking in RAG](https://arxiv.org/abs/2603.03919)
...
### [28] [OMNIINTENT: A Trusted Intent-Centric Framework for User-Friendly Web3](https://arxiv.org/abs/2603.04168)
...
### [29] [CAM-LDS: Cyber Attack Manifestations for Automatic Interpretation of System Logs and Security Alerts](https://arxiv.org/abs/2603.04186)
...
### [30] [Statistical Effort Modelling of Game Resource Localisation Attacks](https://arxiv.org/abs/2603.04261)
...
### [31] [Asymmetric Goal Drift in Coding Agents Under Value Conflict](https://arxiv.org/abs/2603.03456)
...
### [32] [Build, Judge, Optimize: A Blueprint for Continuous Improvement of Multi-Agent Consumer Assistants](https://arxiv.org/abs/2603.03565)
...
### [33] [Mozi: Governed Autonomy for Drug Discovery LLM Agents](https://arxiv.org/abs/2603.03655)
...
### [34] [MAGE: Meta-Reinforcement Learning for Language Agents toward Strategic Exploration and Exploitation](https://arxiv.org/abs/2603.03680)
...
### [35] [AI4S-SDS: A Neuro-Symbolic Solvent Design System via Sparse MCTS and Differentiable Physics Alignment](https://arxiv.org/abs/2603.03686)
*Jiangyu Chen*
...
### [36] [RAGNav: A Retrieval-Augmented Topological Reasoning Framework for Multi-Goal Visual-Language Navigation](https://arxiv.org/abs/2603.03745)
...
### [37] [AgentSelect: Benchmark for Narrative Query-to-Agent Recommendation](https://arxiv.org/abs/2603.03761)
...
### [38] [LifeBench: A Benchmark for Long-Horizon Multi-Source Memory](https://arxiv.org/abs/2603.03781)
...
### [39] [Specification-Driven Generation and Evaluation of Discrete-Event World Models via the DEVS Formalism](https://arxiv.org/abs/2603.03784)
...
### [40] [A Dual-Helix Governance Approach Towards Reliable Agentic AI for WebGIS Development](https://arxiv.org/abs/2603.04390)
...
### [41] [A Rubric-Supervised Critic from Sparse Real-World Outcomes](https://arxiv.org/abs/2603.03800)
...
### [42] [From Threat Intelligence to Firewall Rules: Semantic Relations in Hybrid AI Agent and Expert System Architectures](https://arxiv.org/abs/2603.03911)
...
### [43] [Generative AI in Managerial Decision-Making: Redefining Boundaries through Ambiguity Resolution and Sycophancy Analysis](https://arxiv.org/abs/2603.03970)
...
### [44] [Phi-4-reasoning-vision-15B Technical Report](https://arxiv.org/abs/2603.03975)
...
### [45] [BeamPERL: Parameter-Efficient RL with Verifiable Rewards Specializes Compact LLMs for Structured Beam Mechanics Reasoning](https://arxiv.org/abs/2603.04124)
...
### [46] [Towards Realistic Personalization: Evaluating Long-Horizon Preference Following in Personalized User-LLM Interactions](https://arxiv.org/abs/2603.04191)
...
### [47] [Agentics 2.0: Logical Transduction Algebra for Agentic Data Workflows](https://arxiv.org/abs/2603.04241)
...
### [48] [$τ$-Knowledge: Evaluating Conversational Agents over Unstructured Knowledge](https://arxiv.org/abs/2603.04370)
...
### [49] [Engineering a Governance-Aware AI Sandbox: Design, Implementation, and Lessons Learned](https://arxiv.org/abs/2603.03394)
...
### [50] [Review Beats Planning: Dual-Model Interaction Patterns for Code Synthesis](https://arxiv.org/abs/2603.03406)
*Jan Miller*
...
### [51] [Semantic Neighborhood Density and Eye Gaze Time in Human Programmer Attention](https://arxiv.org/abs/2603.03566)
...
### [52] [CONCUR: Benchmarking LLMs for Concurrent Code Generation](https://arxiv.org/abs/2603.03683)
...
### [53] [SWE-CI: Evaluating Agent Capabilities in Maintaining Codebases via Continuous Integration](https://arxiv.org/abs/2603.03823)
...
### [54] [Empirical Studies on Adversarial Reverse Engineering with Students](https://arxiv.org/abs/2603.03875)
...
### [55] [LoRA-MME: Multi-Model Ensemble of LoRA-Tuned Encoders for Code Comment Classification](https://arxiv.org/abs/2603.03959)
...
### [56] [CodeTaste: Can LLMs Generate Human-Level Code Refactorings?](https://arxiv.org/abs/2603.04177)
...
### [57] [Code Fingerprints: Disentangled Attribution of LLM-Generated Code](https://arxiv.org/abs/2603.04212)
...
### [58] [FeedAIde: Guiding App Users to Submit Rich Feedback Reports by Asking Context-Aware Follow-Up Questions](https://arxiv.org/abs/2603.04244)
...
### [59] [LikeThis! Empowering App Users to Submit UI Improvement Suggestions Instead of Complaints](https://arxiv.org/abs/2603.04245)
